...
void drawScene() {
	...
	line_drawing(0.20,-0.80,0.20,-0.88); // 1

	line_drawing(0.213,-0.80,0.213,-0.88); // 1
	
	line_drawing(0.24,-0.80,0.24,-0.88);
	line_drawing(0.24,-0.80,0.225,-0.80);
	line_drawing(0.225,-0.84,0.225,-0.80);
	line_drawing(0.225,-0.84,0.24,-0.84); // 9
	
	line_drawing(0.25,-0.80,0.25,-0.88);
	line_drawing(0.25,-0.80,0.265,-0.80);
	line_drawing(0.265,-0.88,0.265,-0.80);
	line_drawing(0.25,-0.88,0.265,-0.88); // 0
	
	line_drawing(0.275,-0.88,0.29,-0.88);
	line_drawing(0.29,-0.80,0.29,-0.84);
	line_drawing(0.275,-0.84,0.29,-0.84);
	line_drawing(0.275,-0.84,0.275,-0.88);
	line_drawing(0.275,-0.80,0.29,-0.80); // 2
	
	line_drawing(0.30,-0.80,0.32,-0.80); // 7
	line_drawing(0.32,-0.80,0.30,-0.88); // 
	
	line_drawing(0.33,-0.80,0.33,-0.88);
	line_drawing(0.33,-0.80,0.35,-0.80);
	line_drawing(0.33,-0.84,0.35,-0.84);
	line_drawing(0.35,-0.88,0.35,-0.84);
	line_drawing(0.33,-0.88,0.35,-0.88); // 6
	
	line_drawing(0.36,-0.80,0.38,-0.80); // 7
	line_drawing(0.38,-0.80,0.36,-0.88); // 
...
//      building 4
   ...
   /// field buiding
    ...
    glColor3d(0.55, 0.35, 0.0);
        ...
        glVertex3f(getX(250), getY(300), 0.0f);
        glVertex3f(getX(50), getY(300), 0.0f);
    ...
    glColor3d(0.40, 0.20, 0.0);
        ...
        glVertex3f(getX(265), getY(250), 0.0f);
        glVertex3f(getX(250), getY(300), 0.0f);
        glVertex3f(getX(250), getY(36), 0.0f);
	glEnd();
    glPopMatrix();
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("River side city view");
